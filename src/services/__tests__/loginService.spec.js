...
describe('LoginService', () => {
    ...
    describe('login', () => {
        it('should successfully login with valid credentials', async () => {
            ...
            expect(axios.post).toHaveBeenCalledWith('https://api.example.com/auth/login', {
                username: 'testuser',
    ...
    describe('checkAccountStatus', () => {
        it('should return account status when not locked', async () => {
            ...
            expect(axios.get).toHaveBeenCalledWith('https://api.example.com/auth/status/testuser');
...
//# sourceMappingURL=loginService.spec.js.map