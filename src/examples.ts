...
const exampleVueUsage = {
  ...
  methods: {
    ...
    handleLoginError(errorType: any) {
...
async function exampleLoginWithRetry(username: string, password: string, maxRetries = 3) {
...
export {
  exampleDirectServiceUsage,
  exampleCheckAccountStatus,
  exampleVueUsage,
  exampleLoginWithRetry
};
